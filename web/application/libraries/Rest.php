...
class REST
{
    ...
    // Arjeth: Modified Function 
    // public function post($uri, $params = array(), $format = NULL)
    // {
    //     // Base64 encode each value in the params array
    //     $encoded_params = array_map(function($value) {
    //         return base64_encode($value);
    //     }, $params);

    //     // Call the _call function with the modified parameters
    //     return $this->_call('post', $uri, $encoded_params, $format);
    // }
